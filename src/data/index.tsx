...
export const actions: EbookMark[] = [
  ...
  },
  {
    name: "HIRIST",
    key: "hirist",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with hirist.",
  ...
  },
  {
    ...
    key: "naukri",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with naukri.",
  ...
  },
  {
    ...
    key: "tophire",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with tophire.",
    url: "https://tophire.co/home",
    tags: ["job search"],
  },
  {
    name: "Cuvette",
    key: "cuvette",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with cuvette.",
    url: "https://cuvette.tech/app/student/",
    tags: ["job search"],
  },
  {
    name: "Uplers",
    key: "uplers",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with Uplers.",
    url: "https://ats.uplers.com/talent",
    tags: ["job search"],
  },
  {
    name: "WellFound",
    key: "wellfound",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with WellFound.",
  ...
  },
  {
    ...
    key: "remote-in-tech",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with Remote In Tech.",
  ...
  },
  {
    ...
    key: "cutshort",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with CutShort.",
  ...
  },
  {
    ...
    key: "outscal",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with OutScal.",
    url: "https://outscal.com/jobs",
    tags: ["job search"],
  },
  {
    name: "ResumeWorded",
    key: "resumeworded",
    icon: <GiLaptop size={iconSize} />,
    description: "Check your ATS resume score with ResumeWorded.",
    url: "https://resumeworded.com/index.php",
    tags: ["job search", "resume score"],
  },
  {
    name: "WorkDay",
    key: "workday",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with WorkDay.",
  ...
  },
  {
    ...
    key: "weekday",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with weekday.",
    url: "https://jobs.weekday.works/",
    tags: ["job search"],
  },
  {
    name: "workafy",
    key: "weekday",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with Workafy.",
    url: "https://www.workafy.com/login",
    tags: ["job search"],
  },
  {
    name: "Unstop",
    key: "unstop",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with Unstop.",
  ...
  },
  {
    ...
    key: "expertia",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with Expertia.",
    url: "https://www.expertia.ai/jobs?utm_source=browse-more-jobs",
    tags: ["job search"],
  },
  {
    name: "Remote Jobs",
    key: "remote-jobs",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with Remote Jobs.",
  ...
  },
  {
    ...
    key: "remotive",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with Remote Remotive.",
  ...
  },
  {
    ...
    key: "linkedin",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with Remote linkedin.",
    url: "https://www.linkedin.com/jobs/",
    tags: ["job search"],
  },
  {
    name: "Direct Recruiting",
    key: "direct-recurting",
    icon: <GiLaptop size={iconSize} />,
    description: "Apply for your dream job with Remote Direct Recruiting.",
    url: "https://anask601.notion.site/Direct-Recurting-Links-0a654d63084340b99f25112d7da4c0b7",
    tags: ["job search"],
  },
];
